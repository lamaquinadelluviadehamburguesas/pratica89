...
const ModalEdicionProducto = ({
  ...
  manejoCambioArchivoActualizacion,
  actualizarProducto,
  categorias
}) => {
            ...
            <Form.Group className="mb-3 text-center">
              ...
              {productoEditar.url_imagen ? (
                <div className="mb-2">
                  ...
                  alt="Prodcto actual"
                  style={{ maxWidth: "120%", maxHeight: "120px", objectFit: "cover", borderRadius: "6px" }}
                />
                </div>
              ) : (
          ...
          <Col xs={12} md={12}>
            <Form.Group className="mb-3">
              ...
              <Form.Control
                type="file"
                accept="image/*"
                onChange={manejoCambioArchivoActualizacion}
              />
              <Form.Text className="text-muted">
                si selecciona una nueva imagen, reemplazará a la actual
              </Form.Text>
            </Form.Group>
          </Col>
